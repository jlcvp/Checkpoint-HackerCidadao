...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        CircleOptions circleOptions = new CircleOptions()
                .center(new LatLng(-8.031620, -34.8707034))
...
// Get back the mutable Circle
        ...
        mMap.addMarker(new MarkerOptions().position(new LatLng(-8.0321234, -34.8707608)).title("Posição Atual"));

        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-8.0322220, -34.8707338),16.0f));
